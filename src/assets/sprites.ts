...
export const sprites = {
  ...
  researchDesk: spriteUrl('buildings/research_desk.png'),
  workbench: spriteUrl('buildings/workbench.png'),
  equipAxe: spriteUrl('equipment/axe.png'),
  equipPickaxe: spriteUrl('equipment/pickaxe.png'),
  equipHuntingBow: spriteUrl('equipment/hunting_bow.png'),
  equipHuntingSpear: spriteUrl('equipment/hunting_spear.png'),
  equipSword: spriteUrl('equipment/sword.png'),
  equipIronArmor: spriteUrl('equipment/iron_armor.png'),
  ...
  jobResearch: spriteUrl('ui/job_research.png'),
  jobCraft: spriteUrl('ui/job_craft.png'),
